package com.xinayida.lib.widget.slider;
...
import com.xinayida.lib.widget.slider.model.SliderConfig;
import com.xinayida.lib.widget.slider.model.SliderInterface;
...
public class Slider {
    ...
    public static String TAG = "Slidr";
     ...
     * @return a {@link SliderInterface} that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link SliderConfig}
     *
     * @param activity the activity to attach the slider to
